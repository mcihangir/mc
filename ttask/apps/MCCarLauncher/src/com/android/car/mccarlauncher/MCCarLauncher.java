...
import com.android.car.mccarlauncher.homescreen.HomeCardModule;
 ...
 */
public class MCCarLauncher extends FragmentActivity {
    public static final String TAG = "MCCarLauncher";
...
private Intent getMapsIntent() { 
  Intent i = new Intent();
//  i.setClassName("com.mc.mcandroidautoapp","com.mc.mcandroidautoapp.MainActivity");
  i.setClassName("com.mc.mclauncherpart","com.mc.mclauncherpart.MainActivity");
  return i;
...
*/
    ...
    private Intent getMapsIntent() {
        ...
        for (String intentUri : getResources().getStringArray(
            ...
            if (preferredIntent.resolveActivityInfo(pm, 0) != null) {
